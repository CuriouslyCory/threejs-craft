...
/** Eye height above the feet position — used to place the camera. This is
 *  the single home of the eye/feet convention: `player-controller.tsx` adds
 *  it (feet -> eye) and `interaction.ts` subtracts it (eye -> feet). */
