// three.js — vanilla WebGL starter (no bundler, ESM via <script type="importmap">)
//
// A single lit, rotating cube with OrbitControls. Minimal and boring on purpose —
// copy this folder, serve it over http(s), and it renders. See README.md.
//
// Holds the skill's 7 invariants:
//   1. ESM only (no global THREE)
...
// to page unload / SPA unmount in a real app. Demonstrated here so the pattern
// is copy-pasteable.
function dispose() {
